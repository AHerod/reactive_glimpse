        ...
        <header>
          <nav>
            ...
            <button onClick={handle.active ? handle.exit : handle.enter} className={'fullscreen__btn'}>
              ...
              <svg className={'fullscreen__btn--exit'}xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><defs/><g fill="#A51243"><path d="M24.586 27.414L29.172 32 32 29.172l-4.586-4.586L32 20H20v12zM0 12h12V0L7.414 4.586 2.875.043.047 2.871l4.539 4.543zM0 29.172L2.828 32l4.586-4.586L12 32V20H0l4.586 4.586zM20 12h12l-4.586-4.586 4.547-4.543L29.133.043l-4.547 4.543L20 0z"/></g></svg>
            </button>
          </nav>
        </header>
        <Switch>
